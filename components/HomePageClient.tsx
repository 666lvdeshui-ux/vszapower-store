...
import type { ProductItem, PostItem } from '@/lib/store';
...
export default function HomePageClient({ initialProducts, initialPosts }: { initialProducts: ProductItem[]; initialPosts: PostItem[] }) {
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg-main)', color: 'var(--text-main)', position: 'relative' }}>
      ...
      <ProductGrid initialProducts={initialProducts} onContactClick={handleOpenContact} />
      ...
      <BlogPreview posts={initialPosts}/>
