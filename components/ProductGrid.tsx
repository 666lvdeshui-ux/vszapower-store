...
import { MessageSquare, Info, Shield, Zap, Sparkles, CheckCircle2, ChevronRight, X } from 'lucide-react';
    ...
    <section id="products" style={{
      ...
      <div style={{ textAlign: 'center', marginBottom: '48px' }}>
        ...
        <p style={{ color: 'var(--text-muted)', fontSize: '1.05rem', maxWidth: '640px', margin: '12px auto 0' }}>
          Explore our smart coin cell chargers, LIR rechargeable batteries, and starter kits. Click &quot;View Details&quot; to inspect full specs or &quot;Contact Us&quot; for direct inquiries.
        </p>
      </div>
