...
建议搭配使用 **[Vszapower LIR2032 入门套装](/products/lir2032-starter-kit)**，套装内含 4 节高容量可充电池与 USB 双槽充电器。`
  },
  {
    ...
    cover_image: "https://www.vszapower.com/academy/images/white-charger-lir2032-kit-scene-v2.webp",
...
结合**高密度环保牛皮纸盒包装**，无论是在实验室桌面、家用办公桌还是出差便携包中，都能提供持久可靠的安全保障。`
  },
  {
    ...
    cover_image: "https://www.vszapower.com/academy/images/vz002-single-slot-manufacturer-scene-v2.webp",
